  ...
  return (
    <PolicyContainer>
      <ContentWrapper>
        ...
        <p>
          By accessing or using the Mapr app, you agree to comply with and be bound by these Terms of Service and our <Link href="/privacy-policy">Privacy Policy</Link>. If you do not agree to these terms, you must not use the app.
        </p>
        ...
        <p>
          Your privacy is important to us. For more information on how we collect, store, and use your data, please refer to our <Link href="/privacy-policy">Privacy Policy</Link>. By using the app, you consent to the collection and use of data as described in the Privacy Policy.
        </p>
